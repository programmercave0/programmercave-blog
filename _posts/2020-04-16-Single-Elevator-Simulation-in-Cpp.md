...
![C++ Elevator Simulation]({{ site.url }}/assets/images/2020-04-16-Single-Elevator-Simulation-in-Cpp/c++_elevator_simulation.jpg){:class="img-responsive"}
...
Get the full code on [Github](https://github.com/{{site.github_username}}/Small-Projects/blob/master/Elevator-Design-C++-Implementation/elevator_design.cpp)
