...
description: Notes on SOLID - Liskov Substitution, Interface Segregation, and Dependency
  Inversion from Scaler
...
- Let us take a look at our final version of the `Bird` class from [SOLID - Single Responsibility, Open/Closed Principle](/SOLID-Single-Responsibility-Open-Closed-Principle)
...
![SRP](/assets/images/LLD/Bird3.png)
...
![SRP](/assets/images/LLD/Bird4.png)
...
![SRP](/assets/images/LLD/Bird5.png)
